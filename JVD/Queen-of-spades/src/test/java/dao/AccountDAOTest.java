...
public class AccountDAOTest {
    ...
    private static Account createValidAccount() throws DAOException {
        ...
        builder.setUserID(user.getId())
                ...
                .setSumOfMoney(BigDecimal.valueOf(faker.number().randomDouble(2, 10, 10000)).setScale(3, RoundingMode.HALF_DOWN))
    ...
    public void updateTest() throws DAOException {
        Account profile = dao.receiveAll(new Integer[]{0, 1}).iterator().next();
