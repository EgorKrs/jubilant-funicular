...
public class PicturesInNewsTest {
    ...
    private static PicturesInNews createValidPicturesInNews() throws DAOException {
        News news = newsDAO.receiveAll(new Integer[]{0, 1}).iterator().next();
        Picture picture = pictureDAO.receiveAll(new Integer[]{0, 1}).iterator().next();
...
//    }
    ...
    public void deleteTest() throws DAOException {
        PicturesInNews picturesInNews = dao.receiveAll(new Integer[]{0, 1}).iterator().next();
